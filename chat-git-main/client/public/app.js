(() => {
  ...
  styleEl.textContent = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .room-effect-stage{position:absolute;inset:0;pointer-events:none;z-index:25;overflow:hidden;opacity:0;transition:opacity 0.2s ease;}
    .room-effect-stage.active{opacity:1;}
    .room-effect-layer{position:absolute;inset:-12%;pointer-events:none;}
    .room-effect-flashbands{background:linear-gradient(180deg,rgba(120,190,255,0.16),rgba(18,32,52,0.08));}
    .room-effect-scramble{background:linear-gradient(135deg,rgba(210,50,160,0.14),rgba(40,190,255,0.12));}
    .room-effect-embers{background:linear-gradient(180deg,rgba(255,120,46,0.18),rgba(100,24,8,0.08));}
    .room-effect-frostbyte{background:linear-gradient(180deg,rgba(210,236,255,0.2),rgba(32,50,72,0.08));}
    .room-effect-matrix{background:linear-gradient(180deg,rgba(18,110,48,0.18),rgba(4,24,12,0.08));}
    .room-effect-starlight{background:linear-gradient(180deg,rgba(132,156,240,0.16),rgba(28,28,60,0.08));}
    .room-effect-flashbands .room-effect-layer-a{background:repeating-linear-gradient(180deg,transparent 0 16px,rgba(180,230,255,0.28) 16px 26px,transparent 26px 46px);mix-blend-mode:screen;animation:roomFlashbands 4.4s linear infinite;}
    .room-effect-flashbands .room-effect-layer-b{background:linear-gradient(90deg,transparent,rgba(210,240,255,0.28),transparent);transform:translateX(-120%);animation:roomSweepX 3.6s ease-in-out infinite;}
    .room-effect-scramble .room-effect-layer-a{background:linear-gradient(90deg,rgba(255,50,150,0.18),transparent 30%,rgba(50,220,255,0.2) 65%,transparent);mix-blend-mode:screen;animation:roomScrambleShift 0.16s steps(2,end) infinite;}
    .room-effect-scramble .room-effect-layer-b{background:repeating-linear-gradient(180deg,rgba(255,255,255,0.08) 0 2px,transparent 2px 8px);opacity:0.9;animation:roomScramblePulse 1s ease-in-out infinite;}
    .room-effect-embers .room-effect-layer-a{background:radial-gradient(circle at 15% 85%,rgba(255,150,70,0.34),transparent 28%),radial-gradient(circle at 78% 18%,rgba(255,196,90,0.24),transparent 22%),radial-gradient(circle at 52% 62%,rgba(255,110,60,0.22),transparent 20%);animation:roomEmbersGlow 2.4s ease-in-out infinite;}
    .room-effect-embers .room-effect-layer-b{background:repeating-radial-gradient(circle at center,rgba(255,220,160,0.16) 0 2px,transparent 2px 22px);mix-blend-mode:screen;animation:roomEmbersRise 6s linear infinite;}
    .room-effect-frostbyte .room-effect-layer-a{background:linear-gradient(135deg,rgba(200,236,255,0.3),transparent 35%,rgba(255,255,255,0.16) 50%,transparent 70%);transform:translateX(-100%);animation:roomFrostSweep 4.2s ease-in-out infinite;}
    .room-effect-frostbyte .room-effect-layer-b{background:repeating-linear-gradient(135deg,rgba(220,245,255,0.18) 0 8px,transparent 8px 18px);mix-blend-mode:screen;opacity:0.95;}
    .room-effect-matrix .room-effect-layer-a{background:repeating-linear-gradient(90deg,transparent 0 20px,rgba(92,255,150,0.18) 20px 26px,transparent 26px 46px);animation:roomMatrixFall 4.5s linear infinite;}
    .room-effect-matrix .room-effect-layer-b{background:linear-gradient(180deg,rgba(40,255,120,0.16),transparent 25%,rgba(40,255,120,0.09) 75%,transparent);mix-blend-mode:screen;animation:roomMatrixPulse 1.8s linear infinite;}
    .room-effect-starlight .room-effect-layer-a{background:radial-gradient(circle at 18% 28%,rgba(255,255,255,0.55) 0 1px,transparent 2px),radial-gradient(circle at 72% 18%,rgba(215,228,255,0.45) 0 1px,transparent 2px),radial-gradient(circle at 84% 68%,rgba(255,255,255,0.4) 0 1px,transparent 2px),radial-gradient(circle at 32% 78%,rgba(210,222,255,0.45) 0 1px,transparent 2px);background-size:220px 220px;animation:roomStarsDrift 12s linear infinite;}
    .room-effect-starlight .room-effect-layer-b{background:radial-gradient(circle at center,rgba(210,226,255,0.26),transparent 58%);mix-blend-mode:screen;animation:roomStarsGlow 2.8s ease-in-out infinite;}
