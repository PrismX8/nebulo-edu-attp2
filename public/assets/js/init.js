...
if (!localStorage.getItem("firstOpen")) {
    alert(
        "Tip: About:Blank cloaking is On by default. If you disable it in Settings, allow popups so it can open automatically on future visits."
    );
...
(function () {
    ...
    // Panic Key
    // =====================
    // Handled globally by /assets/js/panic.js
