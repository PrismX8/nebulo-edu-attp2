...
/* harmony import */var set_cookie_parser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! set-cookie-parser */ "./node_modules/.pnpm/set-cookie-parser@2.7.0/node_modules/set-cookie-parser/lib/set-cookie.js");
...
/* harmony import */var _webreflection_idb_map__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @webreflection/idb-map */ "./node_modules/.pnpm/@webreflection+idb-map@0.3.2/node_modules/@webreflection/idb-map/index.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */var _document_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../document.ts */ "./src/client/document.ts");
...
try {
    var _loop = function() {
        ...
        if (window.hasOwnProperty(htmlElement)) {
            ...
            try {
                ...
                for(var _iterator = allAttributes[Symbol.iterator](), _step1; !(_iteratorNormalCompletion = (_step1 = _iterator.next()).done); _iteratorNormalCompletion = true)_loop();
            } catch (err) {
                _didIteratorError = true;
                _iteratorError = err;
            } finally{
    ...
    for(var _iterator = htmlElements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true)_loop();
} catch (err) {
    _didIteratorError = true;
    _iteratorError = err;
} finally{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */var _mercuryworkshop_bare_mux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @mercuryworkshop/bare-mux */ "./node_modules/.pnpm/@mercuryworkshop+bare-mux@2.1.4/node_modules/@mercuryworkshop/bare-mux/dist/index.mjs");
...
/* harmony import */var _location_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./location.ts */ "./src/client/location.ts");
/* harmony import */var _window_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./window.ts */ "./src/client/window.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */var _window_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./window.ts */ "./src/client/window.ts");
/* harmony import */var _location_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./location.ts */ "./src/client/location.ts");
/* harmony import */var _document_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./document.ts */ "./src/client/document.ts");
function _instanceof(left, right) {
    if (right != null && typeof Symbol !== "undefined" && right[Symbol.hasInstance]) {
        return !!right[Symbol.hasInstance](left);
    } else {
...
"./node_modules/.pnpm/@mercuryworkshop+bare-mux@2.1.4/node_modules/@mercuryworkshop/bare-mux/dist/index.mjs": (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* harmony import */var _api_eval_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api/eval.ts */ "./src/client/api/eval.ts");
/* harmony import */var _api_eval_ts__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_api_eval_ts__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */var _api_fetch_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./api/fetch.ts */ "./src/client/api/fetch.ts");
/* harmony import */var _api_fetch_ts__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_api_fetch_ts__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */var _api_history_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api/history.ts */ "./src/client/api/history.ts");
/* harmony import */var _api_history_ts__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_api_history_ts__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */var _api_websocket_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./api/websocket.ts */ "./src/client/api/websocket.ts");
/* harmony import */var _api_xmlhttprequest_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./api/xmlhttprequest.ts */ "./src/client/api/xmlhttprequest.ts");
/* harmony import */var _api_xmlhttprequest_ts__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_api_xmlhttprequest_ts__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */var _api_open_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./api/open.ts */ "./src/client/api/open.ts");
/* harmony import */var _api_open_ts__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_api_open_ts__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */var _api_postmessage_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./api/postmessage.ts */ "./src/client/api/postmessage.ts");
/* harmony import */var _api_postmessage_ts__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_api_postmessage_ts__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */var _api_navigator_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./api/navigator.ts */ "./src/client/api/navigator.ts");
/* harmony import */var _api_navigator_ts__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_api_navigator_ts__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */var _api_document_ts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./api/document.ts */ "./src/client/api/document.ts");
/* harmony import */var _api_document_ts__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_api_document_ts__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */var _api_worker_ts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./api/worker.ts */ "./src/client/api/worker.ts");
/* harmony import */var _api_worker_ts__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_api_worker_ts__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */var _api_importscripts_ts__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./api/importscripts.ts */ "./src/client/api/importscripts.ts");
/* harmony import */var _api_importscripts_ts__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_api_importscripts_ts__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */var _api_element_ts__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./api/element.ts */ "./src/client/api/element.ts");
/* harmony import */var _api_style_ts__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./api/style.ts */ "./src/client/api/style.ts");
/* harmony import */var _api_style_ts__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_api_style_ts__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */var _api_cookie_ts__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./api/cookie.ts */ "./src/client/api/cookie.ts");
/* harmony import */var _api_origin_ts__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./api/origin.ts */ "./src/client/api/origin.ts");
/* harmony import */var _api_origin_ts__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_api_origin_ts__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */var _api_audio_ts__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./api/audio.ts */ "./src/client/api/audio.ts");
/* harmony import */var _api_audio_ts__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_api_audio_ts__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */var _api_performance_ts__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./api/performance.ts */ "./src/client/api/performance.ts");
/* harmony import */var _api_performance_ts__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(_api_performance_ts__WEBPACK_IMPORTED_MODULE_17__);
/* harmony import */var _api_addeventlistener_ts__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./api/addeventlistener.ts */ "./src/client/api/addeventlistener.ts");
/* harmony import */var _api_addeventlistener_ts__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(_api_addeventlistener_ts__WEBPACK_IMPORTED_MODULE_18__);
